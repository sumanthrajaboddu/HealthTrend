 ...
 * Dynamic color DISABLED — uses fixed brand color scheme only.
 * Supports light and dark mode, following system setting.
...
fun HealthTrendTheme(
    ...
    // Dynamic color is intentionally DISABLED — fixed brand palette only
